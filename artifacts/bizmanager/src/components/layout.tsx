...
function GlobalAlertsBar() {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-2 text-sm font-medium border-b ${
        hasRed ? "bg-red-50 border-red-200 text-red-800" : "bg-amber-50 border-amber-200 text-amber-800"
      }`}
    >
